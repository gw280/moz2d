...
// template<typename i16x8_t>
// i16x8_t ShiftRight16(i16x8_t aM, int32_t aNumberOfBits);

// template<typename i32x4_t>
// i32x4_t ShiftRight32(i32x4_t aM, int32_t aNumberOfBits);
...
template<int8_t aIndex, typename i32x4_t>
inline i32x4_t Splat32(i32x4_t aM);

template<int8_t aIndex, typename u8x16_t>
inline u8x16_t Splat32On8(u8x16_t aM);

template<typename u8x16_t>
inline u8x16_t InterleaveLo8(u8x16_t m1, u8x16_t m2);

template<typename u8x16_t>
inline u8x16_t InterleaveHi8(u8x16_t m1, u8x16_t m2);

template<typename i16x8_t>
inline i16x8_t InterleaveLo16(i16x8_t m1, i16x8_t m2);

template<typename i16x8_t>
inline i16x8_t InterleaveHi16(i16x8_t m1, i16x8_t m2);

template<typename i32x4_t>
inline i32x4_t InterleaveLo32(i32x4_t m1, i32x4_t m2);
...
template<>
inline void Store8<Scalaru8x16_t>(uint8_t* aTarget, Scalaru8x16_t aM)
{
...
template<>
inline Scalari16x8_t Add16<Scalari16x8_t>(Scalari16x8_t aM1, Scalari16x8_t aM2)
{
...
template<>
inline Scalari32x4_t Add32<Scalari32x4_t>(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
...
template<>
inline Scalari16x8_t Sub16<Scalari16x8_t>(Scalari16x8_t aM1, Scalari16x8_t aM2)
{
  return From16<Scalari16x8_t>(aM1.i16[0] - aM2.i16[0], aM1.i16[1] - aM2.i16[1],
                               aM1.i16[2] - aM2.i16[2], aM1.i16[3] - aM2.i16[3],
                               aM1.i16[4] - aM2.i16[4], aM1.i16[5] - aM2.i16[5],
...
template<>
inline Scalari32x4_t Sub32<Scalari32x4_t>(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
  return From32<Scalari32x4_t>(aM1.i32[0] - aM2.i32[0], aM1.i32[1] - aM2.i32[1],
                               aM1.i32[2] - aM2.i32[2], aM1.i32[3] - aM2.i32[3]);
}
...
template<>
inline Scalari16x8_t Min16<Scalari16x8_t>(Scalari16x8_t aM1, Scalari16x8_t aM2)
{
...
template<>
inline Scalari16x8_t Max16<Scalari16x8_t>(Scalari16x8_t aM1, Scalari16x8_t aM2)
{
...
template<>
inline Scalari32x4_t Min32<Scalari32x4_t>(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
...
template<>
inline Scalari32x4_t Max32<Scalari32x4_t>(Scalari32x4_t aM1, Scalari32x4_t aM2)
{
...
template<>
inline Scalari16x8_t Mul16<Scalari16x8_t>(Scalari16x8_t aM1, Scalari16x8_t aM2)
{
...
template<>
inline void Mul16x4x2x2To32x4x2<Scalari16x8_t,Scalari32x4_t>(Scalari16x8_t aFactorsA1B1,
...
template<>
inline Scalari32x4_t MulAdd16x8x2To32x4<Scalari16x8_t,Scalari32x4_t>(Scalari16x8_t aFactorsA,
...
template<>
inline Scalaru8x16_t
InterleaveLo8<Scalaru8x16_t>(Scalaru8x16_t m1, Scalaru8x16_t m2)
{
...
template<>
inline Scalaru8x16_t
InterleaveHi8<Scalaru8x16_t>(Scalaru8x16_t m1, Scalaru8x16_t m2)
{
...
InterleaveLo16<Scalari16x8_t>(Scalari16x8_t m1, Scalari16x8_t m2)
{
...
template<>
inline Scalari16x8_t
InterleaveHi16<Scalari16x8_t>(Scalari16x8_t m1, Scalari16x8_t m2)
{
...
InterleaveLo32<Scalari32x4_t>(Scalari32x4_t m1, Scalari32x4_t m2)
{
...
template<>
inline Scalari16x8_t
UnpackLo8x8To16x8<Scalaru8x16_t,Scalari16x8_t>(Scalaru8x16_t aM)
{
  Scalari16x8_t m;
  m.i16[0] = aM.u8[0];
  m.i16[1] = aM.u8[1];
...
template<>
inline Scalari16x8_t
UnpackHi8x8To16x8<Scalaru8x16_t,Scalari16x8_t>(Scalaru8x16_t aM)
{
  Scalari16x8_t m;
  m.i16[0] = aM.u8[8+0];
  m.i16[1] = aM.u8[8+1];
...
template<>
inline Scalari16x8_t
PackAndSaturate32To16<Scalari32x4_t,Scalari16x8_t>(Scalari32x4_t m1, Scalari32x4_t m2)
{
  Scalari16x8_t m;
...
template<>
inline Scalaru8x16_t
PackAndSaturate16To8<Scalari16x8_t,Scalaru8x16_t>(Scalari16x8_t m1, Scalari16x8_t m2)
{
  Scalaru8x16_t m;
...
template<>
inline void Store8<__m128i>(uint8_t* aTarget, __m128i aM)
{
...
template<>
inline __m128i Add16<__m128i>(__m128i aM1, __m128i aM2)
{
  return _mm_add_epi16(aM1, aM2);
}

template<>
inline __m128i Add32<__m128i>(__m128i aM1, __m128i aM2)
{
  return _mm_add_epi32(aM1, aM2);
}

template<>
inline __m128i Sub16<__m128i>(__m128i aM1, __m128i aM2)
{
  return _mm_sub_epi16(aM1, aM2);
}

template<>
inline __m128i Sub32<__m128i>(__m128i aM1, __m128i aM2)
{
  return _mm_sub_epi32(aM1, aM2);
}

template<>
inline __m128i Min16<__m128i>(__m128i aM1, __m128i aM2)
{
...
template<>
inline __m128i Max16<__m128i>(__m128i aM1, __m128i aM2)
{
  __m128i m1_minus_m2 = _mm_sub_epi16(aM1, aM2);
...
template<>
inline __m128i Min32<__m128i>(__m128i aM1, __m128i aM2)
{
...
template<>
inline __m128i Max32<__m128i>(__m128i aM1, __m128i aM2)
{
  __m128i m1_minus_m2 = _mm_sub_epi32(aM1, aM2);
...
template<>
inline __m128i Mul16<__m128i>(__m128i aM1, __m128i aM2)
{
  return _mm_mullo_epi16(aM1, aM2);
}

template<>
inline void Mul16x4x2x2To32x4x2<__m128i,__m128i>(__m128i aFactorsA1B1,
...
template<>
inline __m128i MulAdd16x8x2To32x4<__m128i,__m128i>(__m128i aFactorsA,
                                                   __m128i aFactorsB)
{
...
template<>
inline __m128i
UnpackLo8x8To16x8<__m128i,__m128i>(__m128i m)
{
...
template<>
inline __m128i
UnpackHi8x8To16x8<__m128i,__m128i>(__m128i m)
{
  __m128i zero = _mm_set1_epi8(0);
...
{
  return UnpackLo8x8To16x8<__m128i,__m128i>(Shuffle32<0,3,2,1>(aM));
}
...
GetOverlappingTwo16From8(__m128i aM1, __m128i aM2)
{
  ...
  return UnpackLo8x8To16x8<__m128i,__m128i>(p4516);
}

template<>
inline __m128i
PackAndSaturate32To16<__m128i,__m128i>(__m128i m1, __m128i m2)
{
...
template<>
inline __m128i
PackAndSaturate16To8<__m128i,__m128i>(__m128i m1, __m128i m2)
{
  // Pack into 16 8bit unsigned integers (saturating).
